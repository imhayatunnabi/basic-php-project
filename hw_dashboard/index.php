<?php
  ...
  $queryHouseBook    = "SELECT * FROM house_booked_list WHERE owner_name = '{$rowHW['name']}'  ORDER BY date DESC LIMIT 10";
  $stmtHouseBook     = $db->prepare($queryHouseBook);
  $resultHouseBook   = $stmtHouseBook->execute();

  $queryHouseCount    = "SELECT COUNT(*) FROM house WHERE owner_name = '{$rowHW['name']}'";
  ...
  $queryHouseBookedCount    = "SELECT COUNT(*) FROM house_booked_list WHERE owner_name = '{$rowHW['name']}'";
          ...
          <div class="row">
            ...
            <div class="col-xxl-6 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Total House</h5>
            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  <h5 class="card-title">Booked List <span>| Last 10</span></h5>
