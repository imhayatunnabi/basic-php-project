      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="assets/img/profile-image/<?php echo $_SESSION['admin_photo'] ?>" alt="Profile" class="rounded-circle">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="location.php">
              <i class="bi bi-circle"></i><span>All Location</span>
            </a>
          </li>
          <li>
            <a href="location_add.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="house.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="house_owner.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="house_booked_list.php">
          ...
          <span>House Booked List Details</span>
        </a>
      </li>
